  ...
  return (
    <div>
     <div className='flex justify-between'>
        ...
        <Link to="/login">
           <button className='w-[7rem] mr-[2rem] p-[0.5rem]  hover:cursor-pointer text-[1rem] hover:bg-[#3e2093] mt-[1rem] bg-[blue] rounded-[6px] text-[white]'>Login</button>
        </Link>
        <Link to="/login">
            <button className='w-[7rem] p-[0.5rem] hover:cursor-pointer text-[1rem] hover:bg-[#3e2093] mt-[1rem] bg-[blue] rounded-[6px] text-[white]'>SignUp</button>
        </Link>
        </div>
